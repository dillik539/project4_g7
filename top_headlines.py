...
from newsapi import NewsApiClient # newsapi.org has a python module called newsapi. Install this module using this code: pip install newsapi-python and import as above


newsapi = NewsApiClient(api_key = 'daaba2aab3d54874a0a154c18715e82c') # initiate the module's object that takes api key as argument

top_headlines = newsapi.get_top_headlines(q = 'white house') # call the predefined function in newsapi module. q is a parameter to search headlines with specific string

all_articles = newsapi.get_everything(q = 'us economy', from_parameter = '2017-01-01', to = '2017-12-31') # 'from_parameter' and 'to' used for date range
...
def get_all_articles():
    ...
    # provides not only the headlines, but everything- headlines, body, paragraph, etc that contains the specified search string
